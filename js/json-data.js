...
const jsonData = [
  ...
  { verb: 'cantar (imp)', s1: 'cantaba', s2: 'cantabas', s3: 'cantaba', p1: 'cantábamos', p2: 'cantabais', p3: 'cantan' },
  { verb: 'planchar (imp)', s1: 'planchaba', s2: 'planchabas', s3: 'planchaba', p1: 'planchábamos', p2: 'planchabais', p3: 'planchan' },
  { verb: 'limpiar (imp)', s1: 'limpiaba', s2: 'limpiabas', s3: 'limpiaba', p1: 'limpiábamos', p2: 'limpiabais', p3: 'limpian' },
  { verb: 'preguntar (imp)', s1: 'preguntaba', s2: 'preguntabas', s3: 'preguntaba', p1: 'preguntábamos', p2: 'preguntabais', p3: 'preguntan' },
  { verb: 'buscar (imp)', s1: 'buscaba', s2: 'buscabas', s3: 'buscaba', p1: 'buscábamos', p2: 'buscabais', p3: 'buscan' },
  { verb: 'escuchar (imp)', s1: 'escuchaba', s2: 'escuchabas', s3: 'escuchaba', p1: 'escuchábamos', p2: 'escuchabais', p3: 'escuchan' },
  { verb: 'esperar (imp)', s1: 'esperaba', s2: 'esperabas', s3: 'esperaba', p1: 'esperábamos', p2: 'esperabais', p3: 'esperan' },
  { verb: 'trabajar (imp)', s1: 'trabajaba', s2: 'trabajabas', s3: 'trabajaba', p1: 'trabajábamos', p2: 'trabajabais', p3: 'trabajan' },
  { verb: 'caminar (imp)', s1: 'caminaba', s2: 'caminabas', s3: 'caminaba', p1: 'caminábamos', p2: 'caminabais', p3: 'caminan' },
  { verb: 'saludar (imp)', s1: 'saludaba', s2: 'saludabas', s3: 'saludaba', p1: 'saludábamos', p2: 'saludabais', p3: 'saludan' },
  { verb: 'estudiar (imp)', s1: 'estudiaba', s2: 'estudiabas', s3: 'estudiaba', p1: 'estudiábamos', p2: 'estudiabais', p3: 'estudian' },
  { verb: 'desayunar (imp)', s1: 'desayunaba', s2: 'desayunabas', s3: 'desayunaba', p1: 'desayunábamos', p2: 'desayunabais', p3: 'desayunan' },
  { verb: 'diseñar (imp)', s1: 'diseñaba', s2: 'diseñabas', s3: 'diseñaba', p1: 'diseñábamos', p2: 'diseñabais', p3: 'diseñan' },
